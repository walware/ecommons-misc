 ...
 * @since 1.5
 */
public class CopyOnWriteIdentityListSet<E> extends AbstractSet<E> implements IdentitySet<E> {
	...
	public synchronized boolean remove(final Object item) {
		final ImIdentityList<E> l= ImCollections.removeElement(this.list, item);
		if (l != this.list) {
			this.list= l;
			return true;
		}
