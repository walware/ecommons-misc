 ...
 * @since 1.5
 */
final class ImArrayIdentitySet<E> extends AbstractImList<E> implements ImIdentitySet<E>,
		RandomAccess {
	...
	private class Iter extends AbstractImListIter<E> {
		...
		public E next() {
			...
			return ImArrayIdentitySet.this.array[this.cursor++];
		}
		...
		@Override
		public E previous() {
			if (this.cursor <= 0 || ImArrayIdentitySet.this.array.length <= 0) {
				throw new NoSuchElementException();
			}
			return ImArrayIdentitySet.this.array[--this.cursor];
		}
	 ...
	 */
	public ImArrayIdentitySet(final E[] a) {
		this.array= a;
	}
