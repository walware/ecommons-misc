...
public class NonDeletingPositionUpdaterTest extends TestCase {
	...
	protected void setUp() throws Exception {
		this.updater= new NonDeletingPositionUpdater(CATEGORY);
	...
	public void testReplaceRightBefore() throws BadLocationException {
		...
		Assert.assertEquals(2, this.pos.offset);
	...
	public void testReplaceLeftBorderTillRight2() throws BadLocationException {
		this.doc.replace(4, 6, "yyyyyyyy");
		Assert.assertEquals(5, this.pos.offset);
		Assert.assertEquals(5, this.pos.length);
		Assert.assertFalse(this.pos.isDeleted);
	}
