...
public class SharedUIResources {
	...
	public static final String OBJ_MAIN_TAB_ID= UIMiscellanyPlugin.PLUGIN_ID + "/image/obj/main_tab"; //$NON-NLS-1$
	...
	public static final String LOCTOOL_DISABLE_FILTER_IMAGE_ID = UIMiscellanyPlugin.PLUGIN_ID + "/image/loctool/disable-filter"; //$NON-NLS-1$
