...
class BreadcrumbItemDetails {
	...
	public void setTextVisible(final boolean enabled) {
		...
		final GridData data= (GridData) fTextComposite.getLayoutData();
	...
	public void setVisible(final boolean visible) {
		...
		final GridData data= (GridData) fDetailComposite.getLayoutData();
	...
	private void installFocusComposite(final Composite composite) {
		...
		composite.addKeyListener(new KeyListener() {
			...
			public void keyPressed(final KeyEvent e) {
				final BreadcrumbViewer viewer= fParent.getViewer();
			...
			private void openDropDown() {
				...
				final int index= viewer.getIndexOfItem(fParent);
				final BreadcrumbItem parent= fParent.getViewer().getItem(index - 1);
	...
	private void addElementListener(final Control control) {
		control.addMouseListener(new MouseListener() {
			...
			public void mouseDown(final MouseEvent e) {
				...
				final int parentIndex= viewer.getIndexOfItem(fParent) - 1;
				Shell shell= null;
