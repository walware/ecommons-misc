...
public class SimpleFragListBuilder implements FragListBuilder {
  ...
  public FieldFragList createFieldFragList(final FieldPhraseList fieldPhraseList, final int fragCharSize) {
    ...
    final FieldFragList ffl = new FieldFragList( fragCharSize );

    final List<WeightedPhraseInfo> wpil = new ArrayList<WeightedPhraseInfo>();
    final Iterator<WeightedPhraseInfo> ite = fieldPhraseList.phraseList.iterator();
    ...
    while( true ){
      ...
      wpil.clear();
      wpil.add( phraseInfo );
      final int st = phraseInfo.getStartOffset() - MARGIN < startOffset ?
